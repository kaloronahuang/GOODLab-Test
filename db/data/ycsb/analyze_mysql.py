...
def read_workload(task_type : str):
    data = []
    path_dir = os.path.join('/home/kalorona/Develop/GOODLab-Test/db/data/ycsb/raw-data', 'mysql', 'workload' + task_type)
...
def main():
    for c in range(ord('a'), ord('g')):
        ...
        df.to_csv('mysql-ycsb-workload' + chr(c) + '.csv')
